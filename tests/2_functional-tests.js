    ...
    suite('GET /api/stock-prices => stockData object', function() {
      ...
      test('1 stock with like', function(done) {
        ...
        .end(function(err, res){
          ...
          .end(function(err, res) {
            assert.equal(err, null, "err is not null");
            assert.equal(res.body.stockData.likes, oldLikes+1, "liking didn't increaase the like count");
            return done();
          });
        });
      });
      ...
      test('1 stock with like again (ensure likes arent double counted)', function(done) {
        ...
        .end(function(err, res){
          ...
          .end(function(err, res) {
            assert.equal(err, null, "err is not null");
            assert.equal(res.body.stockData.likes, oldLikes, "liking didn't increase the like count");
            return done();
          });
        });
      });
